...
/* Keep browser-side editing previews below roughly 8 MB of RGBA memory per
   image. The server still validates provider-specific pixel limits. */
const ADVANCED_CLIENT_IMAGE_MAX_PIXELS = 2000000;
const ADVANCED_CLIENT_IMAGE_JPEG_QUALITY = 0.88;
