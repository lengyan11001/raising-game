const I18N = {
  ...
  "topup.provider": "Provider",
    ...
    "advanced.wanPromptOptimize": "Wan3 prompt optimization",
    ...
    "referral.commissionCardEyebrow": "Earn commission",
    "referral.commissionCardTitle": "Earn withdrawable commission",
    "referral.commissionCardSubtitle": "Earn 20% when an invited user buys membership or API documentation access.",
    "referral.rewardCardEyebrow": "Credit rewards",
    "referral.rewardCardTitle": "Earn credits from regular top-ups",
    "referral.rewardCardSubtitle": "Invite users to register and complete a regular top-up to earn credit rewards.",
    "referral.membershipCommissionLabel": "$99 membership",
    "referral.membershipCommissionValue": "Earn $19.80 (20%)",
    "referral.apiDocsCommissionLabel": "$1000 API docs",
    "referral.apiDocsCommissionValue": "Earn $200.00 (20%)",
    "referral.invitedUsers": "Invited users",
    "referral.withdrawable": "Withdrawable",
    "referral.totalEarned": "Total earned",
    "referral.walletAddress": "USDT wallet address",
    "referral.walletPlaceholder": "Enter TRC20/ERC20 address",
    "referral.saveWallet": "Save address",
    "referral.requestWithdraw": "Request withdrawal",
    "referral.withdrawalHistory": "Withdrawal history",
    "referral.noWithdrawals": "No withdrawal requests yet.",
    "referral.walletRequired": "Enter your wallet address first.",
    "referral.walletSaved": "Wallet address saved.",
    "referral.noWithdrawable": "There is no withdrawable commission yet.",
    "referral.withdrawalRequested": "Withdrawal request submitted.",
...
Seedance 2.5 reference example (provider seedance25):
...
Seedance 2.5 reference example (provider seedance-nsfw):
...
I18N.zh = {
  ...
  ...(I18N.en || {}),
  "common.on": "\u5f00\u542f",
  "advanced.wanPromptOptimize": "Wan3 \u63d0\u793a\u8bcd\u4f18\u5316",
  "nav.gallery": "探索",
  ...
  "referral.rewardUsed": "已获得奖励",
    ...
    "referral.commissionCardEyebrow": "赚取佣金",
    "referral.commissionCardTitle": "邀请购买，赚取可提现佣金",
    "referral.commissionCardSubtitle": "受邀用户购买会员或接口文档权限后，你可获得金额的 20% 佣金。",
    "referral.rewardCardEyebrow": "积分奖励",
    "referral.rewardCardTitle": "普通充值赚积分",
    "referral.rewardCardSubtitle": "邀请用户注册并完成普通充值，可获得积分奖励。",
    "referral.membershipCommissionLabel": "99 美元会员",
    "referral.membershipCommissionValue": "可赚 19.80 美元（20%）",
    "referral.apiDocsCommissionLabel": "1000 美元接口文档",
    "referral.apiDocsCommissionValue": "可赚 200 美元（20%）",
    "referral.invitedUsers": "邀请人数",
    "referral.withdrawable": "可提现金额",
    "referral.totalEarned": "累计佣金",
    "referral.walletAddress": "USDT 收款地址",
    "referral.walletPlaceholder": "输入 TRC20/ERC20 地址",
    "referral.saveWallet": "保存地址",
    "referral.requestWithdraw": "申请提现",
    "referral.withdrawalHistory": "提现记录",
    "referral.noWithdrawals": "暂无提现记录",
    "referral.walletRequired": "请先填写收款地址",
    "referral.walletSaved": "收款地址已保存",
    "referral.noWithdrawable": "暂无可提现佣金",
    "referral.withdrawalRequested": "提现申请已提交",
...
const SITE_PROFILE_COPY = {
  en: {
    ...
    "welcome.navShowcase": "Showcase",
    "welcome.navWorkflow": "Workflow",
    "welcome.title1": "Make Animation",
    "welcome.title2": "Great Again",
    "welcome.startCreate": "Open the studio",
    "welcome.seeShowcase": "See showcases",
    "welcome.stat1": "From reference to final cut",
    "welcome.stat2": "Models and pipelines",
    "welcome.stat3": "Reusable workflow canvases",
    "welcome.frameHint": "prompt · reference · motion",
    "welcome.chip1": "First / last frame",
    "welcome.chip2": "Character lock",
    "welcome.chip3": "4K",
    "welcome.floatA": "Queue 3/5",
    "welcome.floatB": "Render complete",
    "welcome.featTitle": "One pipeline from idea to final cut",
    "welcome.featSub": "References, camera moves, character consistency and the render queue live in one workspace.",
    "welcome.f1t": "Storyboard & prompts",
    "welcome.f1d": "Break an idea into shots and let prompts fill in executable parameters.",
    "welcome.mock1": "Rooftop at night, neon reflections, slow push-in",
    "welcome.f2t": "Character consistency",
    "welcome.f2d": "Upload one reference and lock the same face, outfit and body across shots.",
    "welcome.f3t": "Camera & pacing",
    "welcome.f3d": "First/last frames, reference video and camera notes stack into the pacing you want.",
    "welcome.f4t": "Workflow & API",
    "welcome.f4d": "Save a tuned flow as a canvas, reuse or share it, or drive it straight through the API.",
    "welcome.showTitle": "Pick a style and start running",
    "welcome.showSub": "These are the template directions already in the studio. Open one and it is an editable project.",
    "welcome.s1t": "Urban rise",
    "welcome.s2t": "Campus sweet",
    "welcome.s3t": "Mystery",
    "welcome.s4t": "Cyber sci-fi",
    "welcome.s5t": "Wuxia",
    "welcome.stepTitle": "Three steps into the studio",
    "welcome.st1": "Log in or sign up",
    "welcome.st1d": "Shared accounts and balance with 123vips.",
    "welcome.st2": "Open the studio",
    "welcome.st2d": "Pick a model, upload references and tune parameters in the custom panel.",
    "welcome.st3": "Run the workflow",
    "welcome.st3d": "Save the flow as a canvas and rerun it in one click.",
    "welcome.ctaTitle": "Render your first shot right now",
    "welcome.ctaSub": "After you sign in the button becomes Create and drops you into the studio.",
    "nav.create": "Create",
  },
  zh: {
    "nav.home": "返回主页",
    ...
    "welcome.navFeatures": "功能",
    "welcome.navShowcase": "示例",
    "welcome.navWorkflow": "工作流",
    "welcome.title1": "让动画",
    "welcome.title2": "再次伟大",
    "welcome.startCreate": "进入创作台",
    "welcome.seeShowcase": "看示例",
    "welcome.stat1": "从参考图到成片",
    "welcome.stat2": "模型与管线可切换",
    "welcome.stat3": "工作流复用与共享",
    "welcome.frameHint": "提示词 · 参考 · 运镜",
    "welcome.chip1": "首尾帧",
    "welcome.chip2": "角色一致",
    "welcome.chip3": "4K",
    "welcome.floatA": "队列 3/5",
    "welcome.floatB": "生成完成",
    "welcome.featTitle": "一条管线，从想法跑到成片",
    "welcome.featSub": "参考图、运镜、角色一致性和队列都在同一个工作台里完成。",
    "welcome.f1t": "分镜与提示词",
    "welcome.f1d": "把想法拆成镜头，提示词自动补全到可执行的参数。",
    "welcome.mock1": "深夜天台，霓虹反光，镜头缓慢推进",
    "welcome.f2t": "角色一致性",
    "welcome.f2d": "上传一张参考图，跨镜头锁定同一个人物与服装。",
    "welcome.f3t": "运镜与节奏",
    "welcome.f3d": "首尾帧、参考视频与运镜描述叠加，命中你想要的节奏。",
    "welcome.f4t": "工作流与 API",
    "welcome.f4d": "把调好的流程存成画布，复用、分享，或直接走接口调。",
    "welcome.showTitle": "挑一个风格，直接开跑",
    "welcome.showSub": "这些是站点里现成的模板方向，点开就是可编辑的工程。",
    "welcome.s1t": "都市逆袭",
    "welcome.s2t": "校园甜宠",
    "welcome.s3t": "悬疑推理",
    "welcome.s4t": "科幻赛博",
    "welcome.s5t": "古风武侠",
    "welcome.stepTitle": "三步进入创作台",
    "welcome.st1": "登录或注册",
    "welcome.st1d": "和 123vips 共用同一套账号与余额。",
    "welcome.st2": "进创建台",
    "welcome.st2d": "自定义面板里选模型、传参考、调参数。",
    "welcome.st3": "跑工作流",
    "welcome.st3d": "把流程存成画布，下次一键复用。",
    "welcome.ctaTitle": "现在就把第一支片子跑出来",
    "welcome.ctaSub": "登录后按钮会变成「创建」，直接进创作台。",
    "nav.create": "创建",
  },
};
