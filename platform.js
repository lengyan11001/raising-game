...
I18N.zh = {
  ...
  "advanced.referenceImageTooLarge": "参考图片不能超过 10MB。",
  ...
  "advanced.imageTooLarge": "图片不能超过 10MB。",
  "assets.eyebrow": "素材",
  "assets.title": "素材库",
...
async function submitAdvancedGenerate() {
  ...
  const prompt = autoPrompt ? advancedCreateModeDefaultPrompt() : (els.advancedPrompt?.value.trim() || "");
  if (!prompt) {
